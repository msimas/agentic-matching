...
DROPPED = {
    ...
    "off_keywords": ["refried"],
}
KEPT_UNRELATED = {"name": "beans_contains_meat", "kind": "boolean", "description": "meat", "fndds_keywords": ["pork"], "off_keywords": ["pork"]}
...
def test_reintroduction_with_different_definition_passes_through():
    ...
    redefined = {**DROPPED, "fndds_keywords": ["cooked", "prepared"], "off_keywords": ["cooked", "prepared"]}
